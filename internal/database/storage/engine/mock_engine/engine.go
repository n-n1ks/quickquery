...
// Source: internal/database/storage/engine/memengine.go
//
// Generated by this command:
//
//	mockgen -source=internal/database/storage/engine/memengine.go -destination=internal/database/storage/engine/mock_engine/memengine.go -package=mock_engine Engine
//
